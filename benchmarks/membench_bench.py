...
def run_membench(
    ...
    print(f"\n{'=' * 58}")
    print(f"  RESULTS — Cortex on MemBench ({mode} mode, top-{top_k})")
    print(f"{'=' * 58}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Cortex × MemBench Benchmark")
