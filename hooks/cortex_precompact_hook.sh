#!/bin/bash
# CORTEX PRE-COMPACT HOOK — Emergency save before compaction
#
...
#       "hooks": [{
#         "type": "command",
#         "command": "/absolute/path/to/cortex_precompact_hook.sh",
#         "timeout": 30
#       }]
#     }]
#   }
...
# Set CORTEX_DIR below if you want the hook to auto-ingest before compaction.
...
# Optional: run cortex ingest synchronously so memories land before compaction
