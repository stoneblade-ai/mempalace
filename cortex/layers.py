#!/usr/bin/env python3
"""
layers.py — 4-Layer Memory Stack for cortex
===================================================
...
Reads directly from ChromaDB (cortex_drawers)
...
class Layer0:
    ...
    Reads from ~/.cortex/identity.txt — a plain-text file the user writes.
    ...
    def __init__(self, identity_path: str = None):
        if identity_path is None:
            identity_path = os.path.expanduser("~/.cortex/identity.txt")
    ...
    def render(self) -> str:
        ...
        if os.path.exists(self.path):
            ...
            self._text = (
                "## L0 — IDENTITY\nNo identity configured. Create ~/.cortex/identity.txt"
            )
