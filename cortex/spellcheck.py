...
Usage:
    from cortex.spellcheck import spellcheck_user_text
...
# CamelCase: ChromaDB, Cortex, LongMemEval
...
if __name__ == "__main__":
    test_cases = [
        ...
        "Cortex cant be fine-tunned if you alredy kno the question",
    ...
    for msg in test_cases:
        result = spellcheck_user_text(msg, known_names={"riley", "sam", "cortex"})
