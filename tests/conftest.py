...
cortex imports — so that module-level initialisations (e.g.
...
# ── Isolate HOME before any cortex imports ──────────────────────────
_original_env = {}
_session_tmp = tempfile.mkdtemp(prefix="cortex_session_")
...
# Now it is safe to import cortex modules that trigger initialisation.
import chromadb  # noqa: E402
import pytest  # noqa: E402

from cortex.config import CortexConfig  # noqa: E402
from cortex.knowledge_graph import KnowledgeGraph  # noqa: E402
